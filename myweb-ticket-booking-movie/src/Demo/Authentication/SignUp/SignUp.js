...
//import './../../../Demo/Authentication/App.css';
                                ...
                                <div className="form-group text-left">
                                    <div className="checkbox checkbox-fill d-inline">
                                        <input type="checkbox" name="checkbox-fill-2" id="checkbox-fill-2"/>
                                            ...
                                            <label htmlFor="checkbox-fill-2" className="cr">Send me the  Newsletter weekly.</label> 
                                    </div>
                                </div>
                                <button className="btn btn-info shadow-2 mb-4">Sign up</button>
